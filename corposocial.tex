...
\multicolumn{1}{|l|}{\cellcolor[HTML]{FFFFFF}Estruturas de Dados I}                         & \multicolumn{1}{l|}{Otac\'ilio de Ara\'ujo Ramos Neto}   & \multicolumn{1}{l|}{Ci\^encia da Computa\c{c}\~ao}             & \multicolumn{1}{l|}{Mestre}             & \multicolumn{1}{l|}{DE}                        \\ \hline
...
\multicolumn{1}{|l|}{Empreendedorismo em Software}                                                         & \multicolumn{1}{l|}{Anna Carolina C. C. da Cunha}       & \multicolumn{1}{l|}{Administra\c{c}\~ao de Empresas} & \multicolumn{1}{l|}{Mestre}       & \multicolumn{1}{l|}{DE}                        \\ \hline
\end{tabular}
\end{table}
...
\multicolumn{8}{|l|}{\begin{tabular}[c]{@{}l@{}}Legenda:\\ SB. = Informática Subsequente; \\ INT. = Cursos Integrados; \\ GEST. = Gestão Comercial; \\ TSI. = Tecnologia em Sistemas para Internet;  \\ CH/SEM.TOT. = Carga Horária Semanal Total; \\ CH/SEM. DOC. = Carga Horária Semanal Média por Docente.\end{tabular}}                                      \\ \hline
\end{tabular}
\end{table}
