...
\end{itemize}
	...
	\multicolumn{4}{|l|}{\begin{tabular}[c]{@{}l@{}}- Pontos de rede individuais para cada estação de trabalho;    \\ - Sistema operacional Windows 10 e Ubuntu;\\ - Java Development Kit 8;\\ - Netbeans 8.0.2;\\ - Eclipse (Java, Java EE e C++);\\ - Python 3.4.3;\\ - Dev-C++;\end{tabular}}                                                \\ \hline
	\rowcolor[HTML]{BBDAFF} 
...
\rowcolor[HTML]{BBDAFF} 
\multicolumn{4}{|c|}{\cellcolor[HTML]{BBDAFF}{\bf Descrição (Materiais, Ferramentas, Softwares)}}                                                                                                                                                                                                                                           \\ \hline
\multicolumn{4}{|l|}{\begin{tabular}[c]{@{}l@{}}- Pontos de rede individuais para cada estação de trabalho;    \\ - Sistema Operacional Windows 10 e Ubuntu;\\ - Python 3.4.3;\\ - Dev-C++; \\ - Network Simulator;\\ - Omnet++;\\ - Cisco Packet Tracer;\\ - Simulador SAP;\\ - Virtual Box.\end{tabular}}                                 \\ \hline
\rowcolor[HTML]{BBDAFF} 
\multicolumn{4}{|c|}{\cellcolor[HTML]{BBDAFF}{\bf Equipamentos}}                                                                                                                                                                                                                                                                            \\ \hline
\rowcolor[HTML]{C0C0C0} 
\multicolumn{1}{|c|}{\cellcolor[HTML]{C0C0C0}Quantidade}                         & \multicolumn{3}{c|}{\cellcolor[HTML]{C0C0C0}Especificações}                                                                                                                                                                                              \\ \hline
...
2                                                                                & \multicolumn{3}{l|}{Roteadores Wireless.}                                                                                                                                                                                                                \\ \hline
2                                                                                & \multicolumn{3}{l|}{Switches.}                                                                                                                                                                                                                           \\ \hline
\end{tabular}
\end{table}
